...
def generate_from_mermas(mermas_path, tpl_art_path, tpl_chk_path, out_path, original_filename):
    ...
    for key in mc_map:
        ...
        # F4:F10 -> composición fija
        chk.cell(row=4, column=6).value = "POLIAMIDA"
        chk.cell(row=5, column=6).value = "ALGODÓN"
        chk.cell(row=6, column=6).value = "POLIESTER"
        chk.cell(row=7, column=6).value = "RAMIO"
        chk.cell(row=8, column=6).value = "LYOCELL"
        chk.cell(row=9, column=6).value = "LINO"
        chk.cell(row=10, column=6).value = "ELASTANO"

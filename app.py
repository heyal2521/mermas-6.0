    ...
    <div class="grid">
      <section class="section-card">
        <div class="section-head">
          <div>
            ...
            <p class="section-desc">Sube un fichero MERMAS (.xlsx) y la app generará el TOP final con las plantillas integradas.</p>
          </div>
      ...
      <section class="section-card">
        <div class="section-head">
          ...
          <div class="tag green">Sin subir archivos</div>
        </div>

        <div class="stack">
          <div class="mini-card">
            <h3>Abrir dashboard</h3>
            <p>El dashboard lee automáticamente el histórico guardado y muestra el estado actual sin cargar nada manualmente.</p>
            <a class="btn btn-secondary" href="/dashboard">Ver dashboard</a>
          </div>

          <div class="mini-card">
            <h3>Histórico guardado</h3>
            <p>Los TOP tratados se guardan automáticamente en el repositorio GitHub dentro de <code>/historico</code>.</p>

...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .hero-top { display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; flex-wrap: wrap; position: relative; z-index: 1; }
    .title { margin: 0; font-size: clamp(28px, 3.4vw, 40px); line-height: 1.02; letter-spacing: -0.03em; }
    .subtitle { margin: 10px 0 0; max-width: 720px; color: rgba(255,255,255,0.86); font-size: 15px; line-height: 1.45; }
    .status-row { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 14px; position: relative; z-index: 1; }
    .pill {
    ...
    .section-head { display: flex; justify-content: space-between; gap: 10px; align-items: flex-start; flex-wrap: wrap; margin-bottom: 14px; }
    .section-title { margin: 0; font-size: 22px; letter-spacing: -0.02em; }
    .section-desc { margin: 6px 0 0; color: var(--muted); font-size: 14px; line-height: 1.45; max-width: 900px; }
    .tag {
      display: inline-flex;
      align-items: center;
      gap: 6px;
    ...
    .mini-card p { margin: 0 0 12px; color: var(--muted); font-size: 13px; line-height: 1.45; }

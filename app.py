...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .tag.amber { background: #fff8e7; color: var(--amber); }
    ...
    <section class="hero">
      <div class="hero-top">
        <div>
          ...
          <p class="subtitle">Generador, histórico acumulado y dashboard interactivo en una sola herramienta. Subes el fichero una vez y trabajas desde ahí.</p>
        </div>
        <div class="tag">⚙️ v6</div>
      </div>
      <div class="status-row">
        <div class="status-pill">✅ Generador operativo</div>
        <div class="status-pill">📚 Histórico inteligente</div>
        <div class="status-pill">📊 Dashboard interactivo</div>
        <div class="status-pill">🔁 Guardado automático</div>
      </div>
    </section>
    ...
    <div class="grid">
      <section class="section-card">
        ...
        <div class="card-grid">
          <div class="mini-card">
            <h3>Crear TOP</h3>
            <p>Genera el Excel final con el formato de plantilla y el mapeo automático de campos.</p>
          ...
          <div class="mini-card">
            <h3>Dashboard</h3>
            <p>Visualiza reincidencias, prioridades, familias y evolución sin descargar Excel.</p>
            <form action="/dashboard" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>TOP MERMAS nuevos</label>
                <input type="file" name="files" multiple accept=".xlsx,.xlsm,.xls" required>
              </div>
              <button class="btn btn-secondary" type="submit">Ver dashboard</button>
            </form>
          </div>

          <div class="mini-card">
            <h3>Histórico acumulado</h3>
            <p>Actualiza el histórico combinando un histórico anterior opcional con nuevos TOP tratados.</p>
            <form action="/historico_acumulado" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>Histórico anterior (opcional)</label>
                <input type="file" name="master" accept=".xlsx">
              </div>
              <div class="form-group">
                <label>TOP MERMAS nuevos</label>
                <input type="file" name="files" multiple accept=".xlsx,.xlsm,.xls" required>
              </div>
              <button class="btn btn-tertiary" type="submit">Actualizar histórico</button>
            </form>
          </div>
        </div>
      </section>
      ...
      <section class="section-card">
        <div class="section-head">
          <div>
            <h2 class="section-title">Histórico guardado</h2>
            <p class="section-desc">Los últimos TOP tratados quedan guardados automáticamente para seguir creciendo con el histórico.</p>
          </div>
          <div class="tag amber">Repositorio /historico</div>
        </div>

        <div class="history-list">
          <div class="history-item">
            <div class="history-left">
              <strong>Últimos TOP tratados</strong>
              <span>Se guardan automáticamente para reutilizarlos en el dashboard.</span>
            </div>
            <div class="tag blue">Automático</div>
          </div>
          <div class="history-item">
            <div class="history-left">
              <strong>Revisión rápida</strong>
              <span>Consulta reincidencias, persistencia y familias con un vistazo.</span>
            </div>
